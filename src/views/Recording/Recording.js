...
import CreateFeed from "./CreateRecording";
import UpdateFeed from "./UpdateRecording";
import {
    Card,
    CardBody,
    CardHeader,
                    ...
                    <Card>
                        ...
                        <CardBody>
                            ...
                            <Table responsive>
                                ...
                                <tbody>
                                    <tr>
                                        <th colSpan="5"><Loader type="Oval" className="mt-4 justify-content-center d-flex"color="#000000"/>
                                            <br/>
                                            <h1 className="justify-content-center d-flex">TAHAP DEBUG</h1>
                                        </th>
                                    </tr>
                                </tbody>
                            </Table>
